  ...
  <div class="relative min-h-[60vh] bg-zinc-950">
    ...
    >
      ...
      <div class="pointer-events-none absolute inset-0 z-0">
        <div
          class="absolute -left-32 -top-32 h-[600px] w-[600px] transform-gpu rounded-full bg-jade-500/20 blur-[100px] will-change-transform"
        />
        <div
          class="absolute -right-32 -top-32 h-[500px] w-[500px] transform-gpu rounded-full bg-brand-500/10 blur-[100px] will-change-transform"
        />
      </div>
      ...
      <Container class="relative z-20">
        <div class="mx-auto max-w-4xl text-center">
          <h1
            class="text-balance bg-gradient-to-r from-emerald-200 via-teal-100 to-emerald-400 bg-clip-text font-display text-2xl font-semibold tracking-[0.08em] text-transparent drop-shadow-sm md:text-4xl"
          >
            {{ pageTitle }}
          </h1>
