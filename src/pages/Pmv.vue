...
import { getPmvActivities, type PmvActivity } from '@/services/pmv'

const items = ref<PmvActivity[] | null>(null)
const errorMsg = ref<string | null>(null)

onMounted(async () => {
  try {
    items.value = await getPmvActivities()
  } catch (e: unknown) {
...
<template>
  <main class="mx-auto max-w-6xl space-y-6 p-6">
    <h1 class="text-2xl font-semibold">PMV</h1>
